...
export const Dialogs = (props: DialogsType) => {
    ...
    let onSendMessageClick = () => props.dispatch(addMessageAC(props.dialogsData.newMessageBody))
    const onNewMessageChange = (event:ChangeEvent<HTMLTextAreaElement>) => props.dispatch(changeMessageBodyAC(event.currentTarget.value))
